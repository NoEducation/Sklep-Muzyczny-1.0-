...
namespace SklepMuzyczny.DI.Ninject.Modules
{
        ...
        : NinjectModule
    {
        public override void Load()
        {
            ...
            string[] includeAssembliesForScan = new string[] { "SklepMuzyczny" };
...
// Register the sitemap node providers
            ...
            // Binding potrzebny w projekcie
            this.Kernel.Bind<ISongRepository>().To<DefaultSongRepository>();
            this.Kernel.Bind<ISessionManager>().To<DefaultSessionManager>();
